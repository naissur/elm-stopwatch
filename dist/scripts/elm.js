...
Elm.Main.make = function (_elm) {
   ...
   var initialModel = {_: {}
                      ...
                      ,paused: false
                      ,started: false
                      ,timeStamps: _L.fromArray([])};
   var timeStringFromMs = function (ms) {
      return function () {
         var seconds = $Basics.truncate(ms / 1000);
         var minutes = seconds / 60 | 0;
         var hours = minutes / 60 | 0;
         var minutesMod = minutes;
         var minutesString = A2($String.padLeft,
         2,
         _U.chr("0"))($Basics.toString(minutesMod));
         var secondsMod = A2($Basics._op["%"],
         seconds,
         60);
         var secondsString = A2($String.padLeft,
         2,
         _U.chr("0"))($Basics.toString(secondsMod));
         var centiSeconds = A2($Basics._op["%"],
         $Basics.truncate(ms / 10),
         100);
         var centiString = A2($String.padLeft,
         2,
         _U.chr("0"))($Basics.toString(centiSeconds));
   ...
   var timeStampsView = F2(function (address,
   model) {
      return function () {
         var nullStamp = {_: {}
                         ,index: -1
         ...
         var renderTimeStamp = F2(function (prevStamp,
         stamp) {
            return A2($Html.div,
            _L.fromArray([$Html$Attributes.$class("stopwatch__timeStamps__stamp")]),
            _L.fromArray([A2($Html.div,
                         _L.fromArray([$Html$Attributes.$class("stopwatch__timeStamps__stamp__index")]),
                         _L.fromArray([$Html.text(A2($Basics._op["++"],
                         "#",
                         $Basics.toString(stamp.index)))]))
                         ,A2($Html.div,
                         _L.fromArray([$Html$Attributes.$class("stopwatch__timeStamps__stamp__difference")]),
                         _L.fromArray([$Html.text(timeStringFromMs(stamp.milliseconds - prevStamp.milliseconds))]))
                         ,A2($Html.div,
                         _L.fromArray([$Html$Attributes.$class("stopwatch__timeStamps__stamp__absolute")]),
                         _L.fromArray([$Html.text(timeStringFromMs(stamp.milliseconds))]))]));
         });
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("stopwatch__timeStamps")]),
         A3($List.map2,
         renderTimeStamp,
         A2($Basics._op["++"],
         model.timeStamps,
         _L.fromArray([nullStamp])),
         A2($List._op["::"],
         pendingStamp,
         model.timeStamps)));
      }();
   ...
   model) {
      return function () {
         ...
         {case "AddTimeStamp":
            return function () {
                 var currentms = model.milliseconds;
                 var index = $List.length(model.timeStamps);
                 var newStamp = {_: {}
                                ,index: index
                                ,milliseconds: currentms};
                 return _U.replace([["timeStamps"
                                    ,A2($List._op["::"],
                                    newStamp,
                                    model.timeStamps)]],
                 model);
            ...
            return _U.replace([["started"
              ...
              model);
            case "UpdateTime":
            return model.started && $Basics.not(model.paused) ? _U.replace([["milliseconds"
                                                                            ,model.milliseconds + action._0]],
              model) : model;}
         _U.badCase($moduleName,
         "between lines 37 and 65");
      }();
   });
   var UpdateTime = function (a) {
      return {ctor: "UpdateTime"
             ,_0: a};
   };
   var updateTimeSignal = A2($Signal._op["<~"],
   UpdateTime,
   $Time.fps(31));
   var AddTimeStamp = {ctor: "AddTimeStamp"};
   var Resume = {ctor: "Resume"};
   var Pause = {ctor: "Pause"};
   var Stop = {ctor: "Stop"};
   var Start = {ctor: "Start"};
   var controlsView = F2(function (address,
   model) {
      return function () {
         var showAddStamp = model.started;
         var showPause = model.started && $Basics.not(model.paused);
         var showResume = model.paused;
         var showStop = model.started || model.paused;
         var showStart = $Basics.not(model.started) && $Basics.not(model.paused);
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("stopwatch__controls")]),
         _L.fromArray([A2($Html.button,
                      _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                             ,_0: "stopwatch__controls__start animate-width"
                                                                             ,_1: true}
                                                                            ,{ctor: "_Tuple2"
                                                                             ,_0: "hidden-animate-width"
                                                                             ,_1: $Basics.not(showStart)}]))
                      ...
                      ,A2($Html.button,
                      _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                             ,_0: "stopwatch__controls__stop animate-width"
                                                                             ,_1: true}
                                                                            ,{ctor: "_Tuple2"
                                                                             ,_0: "hidden-animate-width"
                                                                             ,_1: $Basics.not(showStop)}]))
                                   ,A2($Html$Events.onClick,
                                   address,
                                   Stop)]),
                      _L.fromArray([$Html.text("Stop")]))
                      ,A2($Html.button,
                      _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                             ,_0: "stopwatch__controls__pause animate-width"
                                                                             ,_1: true}
                                                                            ,{ctor: "_Tuple2"
                                                                             ,_0: "hidden-animate-width"
                                                                             ,_1: $Basics.not(showPause)}]))
                                   ,A2($Html$Events.onClick,
                                   address,
                                   Pause)]),
                      _L.fromArray([$Html.text("Pause")]))
                      ,A2($Html.button,
                      _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                             ,_0: "stopwatch__controls__resume animate-width"
                                                                             ,_1: true}
                                                                            ,{ctor: "_Tuple2"
                                                                             ,_0: "hidden-animate-width"
                                                                             ,_1: $Basics.not(showResume)}]))
                                   ,A2($Html$Events.onClick,
                                   address,
                                   Resume)]),
                      _L.fromArray([$Html.text("Resume")]))
                      ,A2($Html.button,
                      _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                             ,_0: "stopwatch__controls__stamp animate-width"
                                                                             ,_1: true}
                                                                            ,{ctor: "_Tuple2"
                                                                             ,_0: "hidden-animate-width"
                                                                             ,_1: $Basics.not(showAddStamp)}]))
                                   ,A2($Html$Events.onClick,
                                   address,
                                   AddTimeStamp)]),
                      _L.fromArray([$Html.text("Stamp")]))]));
      }();
   });
   var view = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("stopwatch__container")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("stopwatch")]),
      _L.fromArray([A2($Html.h3,
                   _L.fromArray([$Html$Attributes.$class("stopwatch__caption")]),
                   _L.fromArray([$Html.text("Stopwatch")]))
                   ,A2($Html.p,
                   _L.fromArray([$Html$Attributes.$class("stopwatch__time")]),
                   _L.fromArray([$Html.text(timeStringFromMs(model.milliseconds))]))
                   ,A2(controlsView,address,model)
                   ,_U.cmp($List.length(model.timeStamps),
                   0) > 0 ? A2(timeStampsView,
                   address,
                   model) : A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([]))]))]));
   ...
   model);
   var StopwatchModel = F4(function (a,
   b,
   c,
   d) {
      return {_: {}
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,update: update
                      ,view: view
                      ,timeStringFromMs: timeStringFromMs
                      ,controlsView: controlsView
                      ,timeStampsView: timeStampsView
                      ,main: main
                      ,model: model
